...
using eSyaLaboratory.WebAPI.Utility;

namespace eSyaLaboratory.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IServiceTemplateCreatorRepository, ServiceTemplateCreatorRepository>();
        }
